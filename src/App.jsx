  ...
  return (
    <div style={{ width: '100vw', height: '100vh', margin: 0, position: 'relative' }}>
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '20px', borderBottom: '1px solid #444', paddingBottom: '15px' }}>
          ...
          <div>
            <button
              ...
              style={{
                background: useFixedPositions ? '#FF9800' : '#9C27B0',
                color: 'white',
                border: 'none',
                padding: '6px 10px',
                borderRadius: '4px',
            ...
            >
              {useFixedPositions ? 'Enable Physics' : 'Fix Positions'}
            </button>
          </div>
          
          <div style={{ marginTop: '8px', fontSize: '11px', opacity: 0.8 }}>
            Status: {useFixedPositions ? 'Fixed Positions' : 'Dynamic Physics'}
          </div>
        </div>
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
            <h4 style={{ margin: '0', fontSize: '14px', color: '#ccc', flex: 1 }}>Node Management</h4>
            <button
      ...
      <ForceGraph3D
        ...
        // Add key prop to force re-render when graphData changes
